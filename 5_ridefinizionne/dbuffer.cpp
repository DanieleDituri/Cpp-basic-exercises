...
dbuffer::dbuffer(dbuffer::size_type size, int value) : _size(0), _buffer(nullptr)
{
...
dbuffer::dbuffer(const dbuffer &other) : _size(0), _buffer(nullptr)
{
    ...
    for (dbuffer::size_type i = 0; i < other._size; i++)
...
int &dbuffer::value(dbuffer::size_type index)
{
    assert(index < _size);
...
const int &dbuffer::value(dbuffer::size_type index) const
{
    assert(index < _size);
